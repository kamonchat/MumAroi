...
public class RestaurList extends AppCompatActivity {
    ...
    private void readAllFromWhere() {
        ...
        SQLiteDatabase objSqlLiteDatabase = openOrCreateDatabase("aroi.db" , MODE_PRIVATE , null);
        switch (indexAnInt){
            case 1:
        ...
        Cursor objCursor = objSqlLiteDatabase.rawQuery("SELECT * FROM restaurantTABLE WHERE Type =" + "'" + strWhere + "'", null);
